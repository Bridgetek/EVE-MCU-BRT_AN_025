...
void eve_asset_properties(const char *assets)
{
    ...
    // Patch
    patch_asset.Flash_Start = /* offset patch_medinfo2.bin */ 0  ;
    patch_asset.Flash_Size = /* size patch_medinfo2.bin */ 3912  ;

    // Icons (200x200)
    icon_assets_large[icon_play].Flash_Start = /* offset play_circle.png */ 43648  ;
    icon_assets_large[icon_play].Flash_Size = /* size play_circle.png */ 6411  ;
    icon_assets_large[icon_pause].Flash_Start = /* offset pause_circle.png */ 37760  ;
    icon_assets_large[icon_pause].Flash_Size = /* size pause_circle.png */ 5857  ;
    icon_assets_large[icon_pulse].Flash_Start = /* offset ecg_heart.png */ 31168  ;
    icon_assets_large[icon_pulse].Flash_Size = /* size ecg_heart.png */ 6557  ;
    icon_assets_large[icon_silence].Flash_Start = /* offset silence.png */ 50112  ;
    icon_assets_large[icon_silence].Flash_Size = /* size silence.png */ 4424  ;

    // Icons (100x100)
    icon_assets_small[icon_lock].Flash_Start = /* offset lock.png */ 12928  ;
    icon_assets_small[icon_lock].Flash_Size = /* size lock.png */ 2188  ;
    icon_assets_small[icon_lock_open].Flash_Start = /* offset lock_open_right.png */ 15168  ;
    icon_assets_small[icon_lock_open].Flash_Size = /* size lock_open_right.png */ 2190  ;
    icon_assets_small[icon_volume_off].Flash_Start = /* offset volume_off.png */ 25664  ;
    icon_assets_small[icon_volume_off].Flash_Size = /* size volume_off.png */ 2926  ;
    icon_assets_small[icon_volume_down].Flash_Start = /* offset volume_down.png */ 24000  ;
    icon_assets_small[icon_volume_down].Flash_Size = /* size volume_down.png */ 1653  ;
    icon_assets_small[icon_volume_up].Flash_Start = /* offset volume_up.png */ 28608  ;
    icon_assets_small[icon_volume_up].Flash_Size = /* size volume_up.png */ 2507  ;
    icon_assets_small[icon_good].Flash_Start = /* offset good.png */ 9280  ;
    icon_assets_small[icon_good].Flash_Size = /* size good.png */ 3627  ;
    icon_assets_small[icon_bad].Flash_Start = /* offset bad.png */ 5184  ;
    icon_assets_small[icon_bad].Flash_Size = /* size bad.png */ 4075  ;
    icon_assets_small[icon_sick].Flash_Start = /* offset sick.png */ 20096  ;
    icon_assets_small[icon_sick].Flash_Size = /* size sick.png */ 3871  ;
    icon_assets_small[icon_off_on].Flash_Start = /* offset off_on.png */ 17408  ;
    icon_assets_small[icon_off_on].Flash_Size = /* size off_on.png */ 2643  ;
}
