...
void eve_asset_properties(const char *assets)
{
    ...
    flashimage = join(assetdir, "flash-817-default.bin");
    ...
    // Images
    Carbon_Fiber_800x480_asset.Flash_Start = /* offset Carbon_Fiber_800x480_ASTC_8X8.raw */ 4096    ;
    Carbon_Fiber_800x480_asset.Flash_Size = /* size Carbon_Fiber_800x480_ASTC_8X8.raw */ 96000    ;
    LED_32x32_asset.Flash_Start = /* offset LED_32x32_ASTC_4X4.raw */ 109312    ;
    LED_32x32_asset.Flash_Size = /* size LED_32x32_ASTC_4X4.raw */ 1024    ;
    Trackmap_96x96_asset.Flash_Start = /* offset trackmap_96x96_ASTC_4X4.raw */ 100096    ;
    Trackmap_96x96_asset.Flash_Size = /* size trackmap_96x96_ASTC_4X4.raw */ 9216    ;
    Arrows_96x192_asset.Flash_Start = /* offset arrows_96x192_ASTC_4X4.raw */ 147776   ;
    Arrows_96x192_asset.Flash_Size = /* size arrows_96x192_ASTC_4X4.raw */ 18432   ;
    Widget_Gear_152x152_asset.Flash_Start = /* offset Widget_Gear_152x152_ASTC_4X4.raw */ 110336    ;
    Widget_Gear_152x152_asset.Flash_Size = /* size Widget_Gear_152x152_ASTC_4X4.raw */ 23104    ;
    Widget_RPM_152x56_asset.Flash_Start = /* offset Widget_RPM_152x56_ASTC_4X4.raw */ 133440    ;
    Widget_RPM_152x56_asset.Flash_Size = /* size Widget_RPM_152x56_ASTC_4X4.raw */ 8512    ;
    Widget_Speed_104x56_asset.Flash_Start = /* offset Widget_Speed_104x56_ASTC_4X4.raw */ 141952    ;
    Widget_Speed_104x56_asset.Flash_Size = /* size Widget_Speed_104x56_ASTC_4X4.raw */ 5824    ;
    Bottom_Bar_800x8_asset.Flash_Start = /* offset Bottom_Bar_800x8_ASTC_4X4.raw */ 223808    ;
    Bottom_Bar_800x8_asset.Flash_Size = /* size Bottom_Bar_800x8_ASTC_4X4.raw */ 6400    ;
    Car_Overhead_44x80_asset.Flash_Start = /* offset Car_Overhead_44x80_ASTC_4X4.raw */ 230208    ;
    Car_Overhead_44x80_asset.Flash_Size = /* size Car_Overhead_44x80_ASTC_4X4.raw */ 3520    ;
    Battery_Cells_40x1440_asset.Flash_Start = /* offset Battery_Cells_40x1440_ASTC_4X4.raw */ 166208    ;
    Battery_Cells_40x1440_asset.Flash_Size = /* size Battery_Cells_40x1440_ASTC_4X4.raw */ 57600    ;

    // Fonts
    eurostile_150_L8.Flash_Start = /* offset eurostile_150_L8.raw */ 233728    ;
